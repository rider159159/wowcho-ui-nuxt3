    ...
    <nav
      ...
      <div class="flex w-full flex-wrap items-center justify-between px-6">
        <div
          ...
          <img src="/logo.svg" @click="router.push('/')" class="cursor-pointer max-w-[calc(100vw-150px)]">
          ...
          <ul
            ...
            <li v-if="!isLogin">
              <div
                ...
                ><CommonMyButton @click.prevent="openLoginModal" class="bg-brand-1 text-white hover:bg-white hover:text-brand-1">登入/註冊</CommonMyButton>
              </div>
      ...
      <div v-if="RWDMenu" class="fixed top-72px left-0 w-screen h-[calc(100vh-72px)] bg-white py-4 px-8">
        <div class="container h-full flex flex-col justify-between mx-auto">
          ...
          <a
            ...
            class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 "
            href="#!"
            ><CommonMyButton @click.prevent="openLoginModal" class="w-full bg-brand-1 text-white hover:bg-white hover:text-brand-1">登入/註冊</CommonMyButton>
          </a>
          ...
          <a
            ...
            class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 "
            href="#!"
            ><CommonMyButton class="w-full bg-white text-brand-1 hover:bg-brand-1 hover:text-white">登出</CommonMyButton></a
          >
        </div>
      </div>
    </transition>
    <!-- 登入註冊彈窗 -->
    <CommonModal v-model="LOGIN_STORE.SHOW_LOGIN_MODAL" @update:modelValue="closeLoginModal">
